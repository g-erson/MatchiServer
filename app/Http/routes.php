...
{
    return '<style> body { margin: auto;padding: 10px;width: 30%; font-family: arial;font-size:93px;font-color:#29293d;}</style> <body><br><img src="http://i.imgur.com/oHPibND.jpg" alt="andreas"> </body>';
});
